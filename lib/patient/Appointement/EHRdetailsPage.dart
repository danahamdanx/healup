          ...
          build: (pw.Context context) {
            return pw.Column(
              ...
              children: [
                    ...
                    pw.Expanded(
                      child: pw.Column(
                        ...
                        children: [
                          ...
                          pw.Text("Name: ${ehr['doctor_name']}", style: pw.TextStyle(fontSize: 22)),
                    ...
                    pw.Expanded(
                      child: pw.Column(
                        ...
                        children: [
                          ...
                          pw.Text("Age: ${ehr['patient_age']}", style: pw.TextStyle(fontSize: 16)),
                ...
                // Signature
                pw.Text('Signature:', style: pw.TextStyle(fontSize: 24, fontWeight: pw.FontWeight.bold)),
                ehrData['seal'] != null && ehrData['seal'].isNotEmpty
                    ? pw.Text('${ehrData['seal']}', style: pw.TextStyle(fontSize: 20, fontWeight: pw.FontWeight.bold))
                    : pw.Text('No seal available', style: pw.TextStyle(fontSize: 20, color: PdfColors.grey)),
              ],
            );
          },
        ),
