...
class _ScheduleScreenState extends State<ScheduleScreen> {
  ...
  Future<void> fetchAppointments() async {
    ...
    final apiUrl = "http://10.0.2.2:5000/api/healup/appointments/patient/$patientId";
    try {
...
// Check if the new selected slot is already booked
  Future<void> updateAppointmentDate(String appointmentId, String newAppDate) async {
    ...
    final apiUrl = "http://10.0.2.2:5000/api/healup/appointments/update-date/$patientId";
