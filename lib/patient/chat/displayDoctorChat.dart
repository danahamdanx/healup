  ...
  Widget build(BuildContext context) {
    if(kIsWeb) {
      return Scaffold(
        ...
        body: Container(
          padding: EdgeInsets.symmetric(horizontal: kIsWeb ? MediaQuery
              .of(context)
              .size
              .width * 0.2 : 0),
          child: Column(
                                  ...
                                  if (messageSnapshot.hasData) {
                                    lastMessage =
                                        messageSnapshot.data!['message'] ??
                                            'No message yet';
                                    isRead =
                                        messageSnapshot.data!['isRead'] ?? true;
                                  }
                                }
                  ...
                  builder: (context, snapshot) {
                    ...
                    return FutureBuilder<List<Doctor>>(
                      ...
                      builder: (context, sortedSnapshot) {
                        ...
                        } else if (!sortedSnapshot.hasData || sortedSnapshot
                            .data!.isEmpty) {
                          return Center(child: Text('No doctors found.'));
                        }
